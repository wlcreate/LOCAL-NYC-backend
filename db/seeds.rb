...
user3 = User.create(first_name: "Anne", last_name: "Green", username: "anne", password: "abc123", bio: "I love finding new places to visit, especially if they've been around a while!")
...
recommendation76 = Recommendation.create(context: "Absolutely in love with this place! The food, the staff, the ambiance! The fettuccine carbonara is a MUST", user: user3, spot: spot1)
...
recommendation8 = Recommendation.create(context: "Delicious food, some of the best aguas frescas you can get anywhere in NYC, and a really wonderful staff who put the money from the restaurant towards important social justice movements that affect the lives of thousands of New Yorkers and their families. Can not recommend more highly! Try the chilaquiles, enchiladas, mole & chile rellenos", user: user2, spot: spot8)
recommendation9 = Recommendation.create(context: "Pretty chill, laid back spot. Good service. Great food. Their Truffle Mac & Cheese is Everything!!", user: user3, spot: spot9)
## Bronx (Riverdale #4)
recommendation10 = Recommendation.create(context: "Most trust worthy sushi spot/ fresh &clean.well reserved! they are polite and I love their lounge music- makes it more cozy and welcoming.", user: user3, spot: spot10)
...
This is my gotta have place. And each time it is shrimp & wing combo (sticky of course), corn on cob and Texas Ginger ale. It is the ultimate hunger fixer. Take a full to go is the only way to leave. It's the hook up. Nice way to spend a Friday afternoon.", user: user3, spot: spot14)
...
## Brooklyn (Bedford-Stuyvesant #6)
recommendation16 = Recommendation.create(context: "This spot is dope! The mac n cheese and cornbread are especially delicious. Really loved their cocktails too- unique and affordable! I actually order Peaches delivery every week! Food and packaging is great and reliable.", user: user2, spot: spot16)
...
recommendation23 = Recommendation.create(context: "This place is a wonderland of food and breathtaking scenic spots including the Brooklyn Bridge Park.  I loved the gourmet food court but the best part of my trip to Empire Stores was the rooftop bar.  Delicious drinks, friendly bartender and relaxing vibe.", user: user2, spot: spot23)
recommendation24 = Recommendation.create(context: "This place is a wonderland of food and breathtaking scenic spots including the Brooklyn Bridge Park.  I loved the gourmet food court but the best part of my trip to Empire Stores was the rooftop bar.  Delicious drinks, friendly bartender and relaxing vibe.", user: user3, spot: spot24)
## Brooklyn (Greenpoint #9)
...
recommendation26 = Recommendation.create(context: "Hands down best quality seafood selection. Great staff, awesome atmoshepre... don't forget about the key lime pie!", user: user2, spot: spot26)
...
## Manhattan (Lower East Side #13)
recommendation37 = Recommendation.create(context: "Had a great afternoon lunch here. Had such a hard time choosing what to get. Everything sounded so good. A great mix of indulgent and healthy. It was a nice day and i sat outside. Couldn’t have been better.", user: user2, spot: spot37)
recommendation38 = Recommendation.create(context: "This place offers some really delicious and unique take on vegetarian food. You should definitely try the chef's menu which changes every week based on a different theme. You may not get the sit down experience you would want because of the pandemic but the quality of food will still leave you wanting for more!", user: user3, spot: spot38)
...
## Manhattan (SoHo #15)
recommendation43 = Recommendation.create(context: "Stopped by for lunch the other day and I can honestly say that this is the best Mediterranean food I've ever had! I had the filet mignon and it was cooked to perfection! They have a very modern set up and a great ambiance. I will definitely be back soon!", user: user3, spot: spot43)
recommendation44 = Recommendation.create(context: "Good place for quality Sushi. it's so appetizing. i had a brother come into town and he asked me to go back here. menu is like a place in San Francisco I loved.", user: user2, spot: spot44)
...
## Queens (Astoria #16)
recommendation46 = Recommendation.create(context: "A true oasis considering the limited amount of such areas in New York. Well kept and clearly valued by all who pass through. However, some workout areas have a terrible odor and need to be thoroughly cleaned", user: user1, spot: spot46)
recommendation77 = Recommendation.create(context: "This park is my favorite to visit, especially since it's not too far from where I work. A nice place to get some fresh air and relax~", user: user3, spot: spot46)
recommendation47 = Recommendation.create(context: "Really good food and service! I love the menu and want to go back to try more! The avocado spring rolls are delicious! I had the seared tuna salad and it was the perfect entree sized salad! The skirt steak was fantastic too. The cocktails are great - try the limeade with lavender.", user: user3, spot: spot47)
recommendation48 = Recommendation.create(context: "The brunch menu was so good I ordered the burrata BLT and my friend ordered the schnitzel and waffles. Both great. Ask to get seated in the back for more secluded and chill vibes. Will be coming back for the dinner menu", user: user2, spot: spot48)
## Queens (Jamaica #17)
recommendation49 = Recommendation.create(context: "I remember back when I was in high school, I would have an hour lunch break, and I always made it my duty to get my food here so I can eat something for lunch and get some food for work. The Door has never disappointed not once! I still til this day recommend The Door to people! From their amazing, delicious food to the dining experience, everything is amazing! Please do stay being the best!", user: user2, spot: spot49)
...
recommendation51 = Recommendation.create(context: "It is very peaceful. You can have a BBQ over there. And you can walk around the pond and it would be very awesome. I to be honest go everyday over there and I still enjoy it. Definitely recommend it spending free time over there!", user: user2, spot: spot51)
## Queens (Long Island City #18)
...
recommendation54 = Recommendation.create(context: "Nice place for walking, running, sharing time with friends or love ones, picnic, or just to find a spot for yourself and read while enjoying the view. I recommend you bring your sun glasses if you are coming before sunset. Blessings!", user: user2, spot: spot54)
recommendation78 = Recommendation.create(context: "Absolutely love this park! Beautiful place to visit in the hustle and bustle of the area", user: user1, spot: spot54)
## Queens (Sunnyside #19)
recommendation55 = Recommendation.create(context: "I always pass through this pizzeria but never had gotten the chance to go inside. I went today to get 2 slices of pizza and I was delighted. Pizza is so good. Its a have to to come to this pizzeria you enjoy every bite. I recommended 100%. Absolutely will come back.", user: user3, spot: spot55)
...
recommendation57 = Recommendation.create(context: "Great collection of drinks.Affordable place to had a pint of beer and some cocktail. Amazing place. Everything was well maintained.", user: user2, spot: spot57)
## Queens (Woodside #20)
...
recommendation59 = Recommendation.create(context: "Food is good, just the right amount of food to eat, not too heavy and the price was just right. I liked the papaya salad and coconut rice.", user: user2, spot: spot59)
recommendation60 = Recommendation.create(context: "My dog loves coming to this park! It is a big park that has a lot of space for all dog sizes. You can see in the picture that there is a small pool. This pool comes out in the summer. Many dogs love it. Especially my golden retriever:) I love how this park also provides bowls to fill water in. My dog will forever come here :)", user: user3, spot: spot60)

## Staten Island (Great Kills #21)
recommendation61 = Recommendation.create(context: "Great area to escape to.  Regular events. Scenic, great for hikes, walks, beach going, boating ,biking star gazing and more.", user: user2, spot: spot61)
...
recommendation63 = Recommendation.create(context: "I would give 10 stars if I could!  Amazing food, great staff! We will be back!", user: user3, spot: spot63)
## Staten Island (New Dorp #22)
recommendation64 = Recommendation.create(context: "They just opened their new beautiful outdoor dining area.  Daytime is relaxing and night time is very beautiful.  They serve hotpot, BBQ grilled, and seafood combo.  Service is good.", user: user3, spot: spot64)
...
recommendation66 = Recommendation.create(context: "Great atmosphere! Everyone enjoyed their coffee. Even purchased an awesome elephant  as a gift. Would highly recommend!!!", user: user2, spot: spot66)
...
recommendation68 = Recommendation.create(context: "What a spectacular venue. This historic, gorgeous, opulent theater is not to be missed.", user: user2, spot: spot68)
...
recommendation75 = Recommendation.create(context: "Great place to visit, something for everyone! Children's museum to the Chinese scholar's garden. Even a Koi pond, and botanic garden!", user: user2, spot: spot75)
